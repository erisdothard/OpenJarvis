...
OPENHANDS_SYSTEM_PROMPT = (  # noqa: E501
    ...
    "- Do NOT use open(), subprocess, os, or urllib directly "
    "in Python code blocks — use the provided tools instead.\n"
    "- For factual claims about current events or recent "
    "information, use a search or retrieval tool before "
    "answering. Do not rely on training data for "
